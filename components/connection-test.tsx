...
export function ConnectionTest() {
  ...
  const testConnection = async () => {
    ...
    try {
      ...
      details.push("✅ Konfigurasi valid")
      ...
      if (!connectionTest.success) {
        ...
        details.push(`❌ Koneksi database: ${connectionTest.error}`)
        return
      }

      setStatus((prev) => ({ ...prev, database: "connected" }))
      details.push("✅ Koneksi database berhasil")
      ...
      if (authError) {
        ...
        details.push(`❌ Auth service: ${authError.message}`)
        return
      }

      setStatus((prev) => ({ ...prev, auth: "connected" }))
      details.push("✅ Auth service aktif")
      ...
      if (tablesError) {
        ...
        details.push(`❌ Akses tabel: ${tablesError.message}`)
        return
      }

      setStatus((prev) => ({ ...prev, tables: "connected" }))
      details.push("✅ Semua tabel dapat diakses")
